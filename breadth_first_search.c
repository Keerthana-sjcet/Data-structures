...
/* algo
find index of startingvertex 
enqueue that startingindex to the queue
mark 1 in visited array where index is startingindex;
in while loop
dequeue
print corresponding vertex from vertices[]
while adj members fom matrix are unvisited enqueue and add to visited
*/
